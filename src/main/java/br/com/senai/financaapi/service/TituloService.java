...
public class TituloService {
    ...
    public List<Titulo> listarPor(@NotNull(message = "A descrição do titulo não pode ser nula") String descricaoTitulo) {
    	return repository.listarPor("%" + descricaoTitulo + "%");
    }
